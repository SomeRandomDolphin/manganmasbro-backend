...
export const recipes = [
  {
    ...
    cook_time: 455,
    thumbnail:
      "https://www.simplyrecipes.com/thmb/81DDN-JmyLF4q4x3ji9US5EinZY=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-Flan-LEAD-4babaa6635e84aa583e40beeffdc9e61.jpg",
  ...
  },
  {
    ...
    cook_time: 80,
    thumbnail:
      "https://www.simplyrecipes.com/thmb/6Rt-QgGkNCX3cBm7IUN-0W8JZC0=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__simply_recipes__uploads__2014__12__swedish-meatballs-vertical-a-1800-3083961bedc349f28fcf3b42f2f9a0e9.jpg",
    origin: Scandinavian,
    ingredient_id: 2,
    measure_id: 2,
    step_id: 2,
  ...
  },
  {
    ...
    cook_time: 6,
    thumbnail:
      "https://www.simplyrecipes.com/thmb/4JFyH0WJwRhUpSpntwZQTzxhOpo=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-Microwave-Bacon-LEAD-1-0b402bfbfba14b84b62c28afe288ea60.jpg",
    origin: Western,
    ingredient_id: 3,
    measure_id: 3,
    step_id: 3,
  ...
  },
  {
    ...
    cook_time: 55,
    thumbnail:
      "https://www.simplyrecipes.com/thmb/4hc8OyybQ9Wh53NVEx8vxQzfKvI=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__simply_recipes__uploads__2019__05__Chicken-Korma-LEAD-1-68475a749cd646b89137c9f6fddf6122.jpg",
    origin: Indian,
    ingredient_id: 5,
    measure_id: 5,
    step_id: 5,
  ...
  },
  {
    ...
    cook_time: 16,
    thumbnail:
      "https://www.simplyrecipes.com/thmb/GlXckt234UJ8z57U3kPzgvpJD0I=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-Spinach-Banchan-LEAD-9-bfab68c0349a40608138205ed159951d.jpg",
    origin: Asian,
    ingredient_id: 6,
    measure_id: 6,
    step_id: 6,
  ...
  },
  {
    ...
    name: "Miso Soup",
    description:
      "This version of the traditional Japanese dish, Miso Soup is drizzled with sesame oil and sprinkled with togarashi for a lightly smoky and savory spin.",
    category: Soup,
    vegan: true,
    cook_time: 30,
    thumbnail:
      "https://www.simplyrecipes.com/thmb/KSmzTEtoPAP4lY-zifb5maKHnPk=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-Miso-Soup-LEAD-8-423fc6f9345148e68b570a7ba29e5748.jpg",
    origin: Asian,
    ingredient_id: 7,
    measure_id: 7,
    step_id: 7,
  ...
  },
  {
    ...
    cook_time: 100,
    thumbnail:
      "https://www.simplyrecipes.com/thmb/ORuftUM3byXimFlYyas4QE4RQGs=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-Chicken-Adobo-LEAD-3-ac4f46d35d494effa40d935b93320f9d.jpg",
